...
routerHp.get("/smartphone/:kdSmartphone", ctrlHp.getHpByKdSmartphone);
//untuk menambahkan data ke mysql atau db
routerHp.post("/smartphone", ctrlHp.insertHp);
//untuk update data
routerHp.put("/smartphone/:kdSmartphone", ctrlHp.updateHp);
//untuk menghapus data bykdSmartphone
routerHp.delete("/smartphone/:kdSmartphone", ctrlHp.deleteHp);
